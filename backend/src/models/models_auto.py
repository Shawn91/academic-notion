...
#   timestamp: 2024-05-16T14:32:32+00:00
...
class NAccessTokenOwnerUser(BaseModel):
...
class NAccessTokenOwnerWorkspace(BaseModel):
    workspace: Optional[Workspace] = None


class NAccessToken(BaseModel):
    access_token: str
    bot_id: str
    workspace_id: str
    ...
    request_id: str
    owner: Union[NAccessTokenOwnerUser, NAccessTokenOwnerWorkspace]
